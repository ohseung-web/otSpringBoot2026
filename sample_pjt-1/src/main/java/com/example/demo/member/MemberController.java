...
public class MemberController {
    ...
    private final SamplePjt1Application samplePjt1Application;

    MemberController(SamplePjt1Application samplePjt1Application) {
        this.samplePjt1Application = samplePjt1Application;
    }
